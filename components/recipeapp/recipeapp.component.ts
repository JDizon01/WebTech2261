...
import { Recipe } from '../../ING_1/Recipe.class'; // Import Recipe Componentimport { Component, OnInit } from '@angular/core';
import { Ingredient } from '../../ING_1/Ingredient.class';
...
export class RecipeComponent implements OnInit {
    ...
    bottleNames = 'The greatest bottle in the world';
    // Example 1
